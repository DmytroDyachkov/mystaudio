...
//   (function(){
//     var _thisForma;
//     $('.btn__call').on('click', function(){
//       $('.popup__call').fadeIn();
//       _thisForma = $('.popup__call');
//     });
//     $('.btn__viewing').on('click', function(){
//       $('.popup__viewing').fadeIn();
//       _thisForma = $('.popup__viewing');

//     });
//     $('.btn__demand').on('click', function(){
//       $('.popup__demand').fadeIn();
//       _thisForma = $('.popup__demand');
      
//     });
  
//     $('.popup__close').on('click',function(){
//       $('.popup__call').fadeOut();
//       $('.popup__demand').fadeOut();
//       $('.popup__viewing').fadeOut();
//       $('.popup__thanks').fadeOut();
//       $('.popup__error').fadeOut();
//       $('.popup__err').fadeOut();
//     });
  
//     $('.popup__btn-error').on('click', function() {
//       $('.popup__error').fadeOut();
//       _thisForma.fadeIn();
//     });
//     $('.popup__btn-err').on('click',function(){
//       $('.popup__err').fadeOut();
//     });
//     $('.popup__btn-thanks').on('click',function(){
//       $('.popup__thanks').fadeOut();
//     });
...
//         $('form[name=site-form]').trigger('reset');
//       }).fail(function() {
//         $('.popup__call').fadeOut();
//         $('.popup__err').fadeIn();
//         $('form[name=site-form]').trigger('reset');
...
//       e.preventDefault();
//       });
//     $('#form-viewing').submit(function(e) {
//       var $mainForm = $(this);
//       $.ajax({
//         type: $mainForm.attr('method'),
//         url: $mainForm.attr('action'),
...
//         $('.popup__viewing').fadeOut();
//         $('.popup__thanks').fadeIn();
//         $('form[name=form-viewing]').trigger('reset');
//       }).fail(function() {
//         $('.popup__viewing').fadeOut();
//         $('.popup__error').fadeIn();
//         $('form[name=form-viewing]').trigger('reset');
...
//         $('.popup__call').fadeOut();
//         $('.popup__thanks').fadeIn();
//         $('form[name=form-call]').trigger('reset');
//       }).fail(function() {
//         $('.popup__call').fadeOut();
//         $('.popup__error').fadeIn();
//         $('form[name=form-call]').trigger('reset');
...
//         $('.popup__demand').fadeOut();
//         $('.popup__thanks').fadeIn();
//         $('form[name=form-demand]').trigger('reset');
//       }).fail(function() {
//         $('.popup__demand').fadeOut();
//         $('.popup__error').fadeIn();
//         $('form[name=form-demand]').trigger('reset');
